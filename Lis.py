...
# Header
st.markdown(
    "<h1 style='text-align: center;'>🤖 AN Project</h1>", unsafe_allow_html=True
)
st.markdown(
    "<p style='text-align: center; color: gray;'>Official Links & AI"
    " Service</p>",
...
st.link_button(
    "🌐 Link AI V2", "https://short-url.cc/1CuUK", use_container_width=True
)
  ...
  if not prompt:
    ...
    try:
      ...
      with st.spinner("Sedang memproses..."):
        ...
        # Prompt khusus identitas AN AI
        system_prompt = (
            "Nama kamu adalah AN AI (atau AN). Kamu adalah kecerdasan buatan "
            "yang dikembangkan oleh AN Project. Jika ada yang bertanya siapa"
            " kamu "
            "atau siapa yang membuatmu, jawablah bahwa kamu adalah AN AI dari"
            " AN Project."
        )
